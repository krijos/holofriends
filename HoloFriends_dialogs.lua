...
StaticPopupDialogs["HOLOFRIENDS_GETREALIDNAMEBTAG"] = {
	text = HOLOFRIENDS_DIALOGGETREALIDNAMEBTAG,
	button1 = OKAY,
	button2 = CANCEL,
	hasEditBox = 1,
	maxLetters = 49,
...
StaticPopupDialogs["HOLOFRIENDS_GETREALIDNAMEBNETID"] = {
	text = HOLOFRIENDS_DIALOGGETREALIDNAMEBNETID,
	button1 = OKAY,
	button2 = CANCEL,
	hasEditBox = 1,
	maxLetters = 49,
...
StaticPopupDialogs["HOLOFRIENDS_ADDGROUP"] = {
	text = HOLOFRIENDS_WINDOWMAINADDGROUP,
	button1 = OKAY,
	button2 = CANCEL,
	hasEditBox = 1,
	maxLetters = 29,
...
StaticPopupDialogs["HOLOFRIENDS_RENAMEGROUP"] = {
	text = HOLOFRIENDS_WINDOWMAINRENAMEGROUP,
	button1 = ACCEPT,
	button2 = CANCEL,
	hasEditBox = 1,
	maxLetters = 29,
...
StaticPopupDialogs["HOLOOPTIONS_DATEFORMAT"] = {
	text = HOLOFRIENDS_DIALOGDATEFORMAT,
	button1 = CONTINUE,
	hasEditBox = 1,
	maxLetters = 39,
	editBoxWidth = 350,
